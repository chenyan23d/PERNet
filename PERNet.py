...
class PERNet(nn.Module):
    def __init__(self, fun_str1='pvt_v2_b3'):
        ...
        self.mrm3 = MRM(embedding_dims[3] // 4, 256, focus_background=True,
                        opr_kernel_size=7, iterations=1)
        self.mrm2 = MRM(embedding_dims[1], embedding_dims[3] // 4, focus_background=True,
                        opr_kernel_size=7, iterations=1)
        self.mrm1 = MRM(embedding_dims[1], embedding_dims[1], focus_background=True,
                        opr_kernel_size=7,
                        iterations=1)
        self.mrm0 = MRM(embedding_dims[1], embedding_dims[1], focus_background=False,
                        opr_kernel_size=7, iterations=1)
 
        self.dff0 = DFF(cur_in_channels=embedding_dims[0], low_in_channels=embedding_dims[1],
                        out_channels=embedding_dims[1], cur_scale=1, low_scale=2)
        self.dff1 = DFF(cur_in_channels=embedding_dims[1], low_in_channels=embedding_dims[2],
                        out_channels=embedding_dims[1], cur_scale=1, low_scale=2)
        self.dff2 = DFF(cur_in_channels=embedding_dims[2], low_in_channels=embedding_dims[3],
                        out_channels=embedding_dims[1], cur_scale=1, low_scale=2)
        ...
        self.dff3 = DFF(cur_in_channels=128, low_in_channels=256,
        ...
        self.c0 = DCL(embedding_dims[0], 96, 96)
        self.c1 = DCL(embedding_dims[1], 48, 48)
        self.c2 = DCL(embedding_dims[2], 24, 24)
        self.c3 = DCL(embedding_dims[3], 12, 12)
        self.c4 = DCL(embedding_dims[1]*2, 24, 24)
        self.c01 = DCL(embedding_dims[0], 96, 96)
        self.c11 = DCL(embedding_dims[1], 48, 48)
        self.c21 = DCL(embedding_dims[2], 24, 24)
        self.c31 = DCL(embedding_dims[3], 12, 12)
        self.c41 = DCL(embedding_dims[1]*2, 24, 24)
    ...
    def forward(self, x):
        ...
        fgc3, predict3, edge3 = self.mrm3(u4, u51, predict4, edge4,4)
        fgc2, predict2, edge2 = self.mrm2(u3, fgc3, predict3, edge3,3)
        fgc1, predict1, edge1 = self.mrm1(u2, fgc2, predict2, edge2,2)
        fgc0, predict0, edge0 = self.mrm0(u1, fgc1, predict1, edge1,1)
